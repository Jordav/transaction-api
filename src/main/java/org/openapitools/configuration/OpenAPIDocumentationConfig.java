...
public class OpenAPIDocumentationConfig {
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder()
            .title("TransMng API")
            .description("POC for transaction managment API ")
            .license("")
    ...
    @Bean
    public Docket customImplementation(ServletContext servletContext, @Value("${openapi.transMng.base-path:}") String basePath) {
